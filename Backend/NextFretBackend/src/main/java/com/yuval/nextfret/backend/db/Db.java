...
/**
 * Db.java – שכבת גישה ל־PostgreSQL, מקבלת את פרטי החיבור מ־application.properties.
 */
@Component
public class Db {
    ...
    public List<Song> getRecommendationsForUser(Long userId) {
        List<Song> songs = new ArrayList<>();
        // דוגמה לשאילתא בסיסית – מחזירה את כל השירים. אם תרצה להגביל לפי אקורדים/עדפות למשתמש,
